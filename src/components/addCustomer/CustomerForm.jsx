...
import { addCustomer } from "../../features/customerSlices/customersSlice";
...
export default function CustomerForm(props) {
  ...
  return (
    <>
      <SuccesAlert
        alertMessage="Successfully Added Customer Details"
      ...
      <Card border="danger" style={{ margin: "1rem" }}>
        <Card.Header style={{ backgroundColor: "snow" }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <h3 style={{ fontFamily: "Lato" }}> Add Customer Details</h3>
            <Button
              onClick={() => navigate("/")}
              type="button"
              ...
              <Row>
                ...
                <Col>
                  ...
                  <div style={{ textAlign: "end" }}>
                    <Button onClick={clearForm} variant="outline-warning">
                      Clear All
                    </Button>
                    <Button
                      type="submit"
